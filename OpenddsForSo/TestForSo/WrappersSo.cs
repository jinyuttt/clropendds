...
[      UnmanagedFunctionPointer(CallingConvention.StdCall,SetLastError = true)]
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        [DllImport("libOpenddsForSo.so", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <returns></returns>
        [DllImport("libOpenddsForSo.so", CallingConvention = CallingConvention.Cdecl,CharSet =CharSet.Ansi)]
...
[DllImport("libOpenddsForSo.so", CallingConvention = CallingConvention.Cdecl)]
public static extern void SetQueueMsg();

[DllImport("libOpenddsForSo.so", CallingConvention = CallingConvention.Cdecl)]
public static extern void Consumer(ref IntPtr data,ref long datalen);

[DllImport("libOpenddsForSo.so", CallingConvention = CallingConvention.Cdecl)]
public static extern int GetQueueMsgSize();
        /// <summary>
        /// 订阅数据，最新创建域上订阅，一般一个域时
        /// </summary>
        /// <param name="topicname">主题</param>
        /// <param name="func">接收回调</param>
        [DllImport("libOpenddsForSo.so",CallingConvention = CallingConvention.StdCall)]
        public static extern int SubscribeMsg(string topicname,[MarshalAs(UnmanagedType.FunctionPtr)]  FuncPtr func);
